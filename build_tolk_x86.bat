...
cl /nologo /c /O2 /EHsc /GL /GR- /MD /vmb /vms /MP /W4 /WL /D_DLL /D_EXPORTING /D_UNICODE /D_USRDLL /D_WINDLL /D_WINDOWS /DNDEBUG /DWIN32 /DUNICODE /Fobin\x86\ src\*.c src\*.cpp src\java\*.cpp src\reaper\*.cpp
