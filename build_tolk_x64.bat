...
cl /nologo /c /O2 /EHsc /GL /GR- /MD /vmb /vms /MP /W4 /WL /D_DLL /D_EXPORTING /D_UNICODE /D_USRDLL /D_WINDLL /D_WINDOWS /DNDEBUG /DWIN64 /DUNICODE /Fobin\x64\ src\*.c src\*.cpp src\java\*.cpp src\reaper\*.cpp
