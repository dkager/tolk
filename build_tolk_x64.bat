...
cl /nologo /c /Ob2 /Oi /Ot /Oy /EHsc /GF /GL /GR- /Gs /Gy /MD /vmb /vms /MP /W3 /WL /DUNICODE /D_DLL /D_UNICODE /DWIN64 /DNDEBUG /D_WINDOWS /D_USRDLL /D_WINDLL /D_EXPORTING /Fobin\x64\ src\*.c src\*.cpp src\java\*.cpp
